...
app.get('/images', function (req, res) {
    let randChoice = Math.floor(Math.random() * 6) + 1; //returns a random number from 1 to 6
    let chosenImg = "image" + randChoice + ".html";
    
    
    res.sendFile(path.join(__dirname, chosenImg));
